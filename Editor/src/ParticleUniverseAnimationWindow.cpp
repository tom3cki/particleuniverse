	...
	mAnimationPlayPauseStop(ANIM_NONE)
{
	...
	mTxtAnimation = new wxStaticText(mAnimationPanel, -1, wxString::FromAscii("Animation"));
	mListAnimations = new wxComboBox(mAnimationPanel, wxID_ANY, wxString::FromAscii(""), wxDefaultPosition, wxSize(0.5 * LB_TEMPLATES_WIDTH, wxDefaultSize.y), 0, 0, wxCB_READONLY | wxCB_SORT);
	...
	mPauseAnimationButton = new wxButton(mAnimationPanel, ID_PLAY_ANIMATION, wxString::FromAscii("Pause"));
	mPlayAnimationButton = new wxButton(mAnimationPanel, ID_PLAY_ANIMATION, wxString::FromAscii("Play"));
	mStopAnimationButton = new wxButton(mAnimationPanel, ID_PLAY_ANIMATION, wxString::FromAscii("Stop"));
	...
	mCheckboxLoopAnimation = new wxCheckBox(mAnimationPanel, ID_TOGGLE_LOOP, wxString::FromAscii("Loop Animation"));
	mCheckboxInheritOrientationFromBone = new wxCheckBox(mAnimationPanel, ID_TOGGLE_INHERIT_ORIENTATION_FROM_BONE, wxString::FromAscii("Inherit bone orientation"));
...
// 		mMeshInfo->InsertItem(index, wxString::Format(_("Material submesh(%u): %s"), i, materialName));
      mMeshInfo->InsertItem(index, wxString::Format(wxT("Material submesh(%u): "), i) + materialName);
		++index;
	}
